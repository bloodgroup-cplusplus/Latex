...
\pagebreak
\textbf{Reflection of identity on a vertical line ( reflection on y-axis) as \[f_v\] }
\begin{center}
    \includegraphics[scale = 0.9,width = 2cm] {images/y_axis.png}
\end{center}

\textbf{Reflection of identity on a horizontal line ( reflection on x-axis) as \[f_h\] }
\begin{center}
    \includegraphics[scale = 0.9, width = 2cm] {images/y_axis.png}
